...
@section('content')
    <div><h4 class="card-title text-uppercase">Thêm mới cuộc hẹn</h4></div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <div>
                        <input type="datetime-local" class="form-control" name="appointment_at" id="appointment_at" >
                ...
                <div class="form-group">
                    ...
                    <div >
                        <textarea type="text" class="form-control" id="editor" name="notes" placeholder="Nhập ghi chú"></textarea>
                        @error('notes')
